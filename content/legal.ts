...
export const rechtsSeiten: ServicePage[] = [
  ...
  // <p>-Tags 4 offen/4 geschlossen).
  {
    slug: "impressum",
    title: "Impressum",
    // Struktur wie im Original-Impressum: die Blocklabels sind Zwischenüberschriften,
    // die zugehörigen Zeilen darunter Absätze. Text verbatim übernommen.
    blocks: [
      {
        type: "paragraph",
        text: "Herr Johann Gallhofer hat 1987 die Firma von Herrn Michael Duacsek übernommen und gründete gemeinsam mit Herrn Duacsek die Duacsek GmbH, die dann nach dem Ausscheiden des Herrn Duacsek in Gallhofer GmbH umbenannt wurde. Zum damaligen Zeitpunkt existierte die Firma Michael Duacsek schon über 30 Jahre. Die Firma ist somit über 60 Jahre alt.",
      },
      { type: "heading", text: "Gallhofer Gesellschaft m.b.H." },
      { type: "paragraph", text: "Viktorgasse 20, 1040 Wien" },
      { type: "paragraph", text: "Tel.: 01/749 14 56" },
      { type: "heading", text: "Zweigstelle:" },
      { type: "paragraph", text: "Schloßbergstraße 20, 7212 Forchtenstein" },
      { type: "heading", text: "Bürozeiten:" },
      { type: "paragraph", text: "Montag – Donnerstag von 8:00 - 12:00 und 13:00 - 16:00" },
      { type: "paragraph", text: "Freitag von 8:00 - 12:00" },
      { type: "heading", text: "Mobilnummern:" },
      { type: "paragraph", text: "Gallhofer Johannes – Geschäftsführer" },
      { type: "paragraph", text: "Gallhofer Johann – Inhaber" },
      { type: "paragraph", text: "Barbara Gallhofer – Sekretärin: 0650/749 14 56" },
      { type: "paragraph", text: "Barbara Fass – Buchhaltung: 01/749 14 56" },
      { type: "paragraph", text: "E-Mail: office@gallhofer-haustechnik.at" },
      { type: "paragraph", text: "Internet: www.gallhofer-haustechnik.at" },
      { type: "paragraph", text: "FB Nr. 76806a UID: ATU15599706 DG Nr. 200623312" },
    ],
